...
curl 'http://127.0.0.1/v1/admin/api/system_ifaceinfo?_=1473220097423&token=1e07d6566203eb30a088f17bcab3363d'
...
curl 'http://127.0.0.1/v1/admin/api/system_set?token=d77f1cd99f63302c212f926c37b94db3' -d 'cmd=reset'
