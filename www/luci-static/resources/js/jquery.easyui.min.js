...
$('.window-shadow').css("position","absolute"); //zhang add
_23();
}
...
if (opts.onUnselect)
	opts.onUnselect.call(_2c5, _2ca, _2a7(_2c5, _2c8));
}
_2c8.panel("open");
...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"请选择一个值!",invalidMessage:null,rules:{email:{validator:function(_39c){
