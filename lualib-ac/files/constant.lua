...
local default_config_dir = arch.default_config_dir()
...
local const = {
	...
	default_cloud_config= default_config_dir.."/".."cloud.json", --云端账号配置
	...
	default_version		= default_config_dir.."/".."default_version.json",
